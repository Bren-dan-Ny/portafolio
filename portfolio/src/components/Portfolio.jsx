        ...
        <div className="port-projects">
          ...
          <div className="project-item">
            ...
            <div className="project-info">
              ...
              <p>
                Implementé un carrito de compras con persistencia de estado
                usando Context API.
              </p>
              {/* Tecnologías */}
          ...
          <div className="project-item">
            ...
            <div className="project-info">
              <h3>To-Do App</h3>
              <p>
                Implementé actualizaciones en tiempo real con re-renders
                optimizados.
              </p>
              {/* Tecnologías */}
              <div className="technologies">
          ...
          <div className="project-item">
            ...
            <div className="project-info">
              <h3>Pokedex</h3>
              <p>
                Consumí la PokeAPI manejando paginación y múltiples endpoints.
              </p>
              {/* Tecnologías */}
              <div className="technologies">
                <span className="tag-portfolio react">React</span>
